  ...
  return (
    <section id="contactPage" ref={contactRef} className={css.contact}>
      ...
      <div className={css.socialLinks}>
        <OutboundLink
          href="https://www.linkedin.com/in/grant-montgomery/"
          target="_blank"
        >
          <svg
            role="img"
        ...
        <OutboundLink href="https://github.com/grantmontgomery" target="_blank">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <OutboundLink href="https://twitter.com/grantcreates" target="_blank">
          <svg
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
